...
exports.LibrarianService = jest.fn().mockReturnValue({
    ...
    getAllAdmin: jest.fn().mockResolvedValue([lib_stub_1.libStub()]),
    getAllLibrarian: jest.fn().mockResolvedValue([lib_stub_1.libStub()]),
    ...
    deleteLib: jest.fn().mockResolvedValue(lib_stub_1.libStub()._id),
